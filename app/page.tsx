...
const services: { icon: ServiceIconName; title: string; description: string; href?: string }[] = [
  ...
  { icon: "commercial", title: "Commercial Property Documentation", description: "Aerial photo, video, and site visuals for property records, planning, marketing, and asset documentation.", href: "/commercial-properties" },
...
const work = [
  ...
  },
  {
    ...
    category: "Commercial Property Documentation",
    image: "/images/journal-center-commercial-property/journal-center-commercial-property-01.jpg",
  ...
  {
    title: "Journal Center Retail Property",
    detail: "Personal aerial documentation project · Albuquerque, New Mexico",
    category: "Commercial Property Documentation",
    image: "/images/journal-center-retail-property/journal-center-retail-property-01.jpg",
  ...
  {
    title: "Journal Center Vacant Land",
    detail: "Personal aerial documentation project · Albuquerque, New Mexico",
    category: "Vacant Land & Development",
    image: "/images/journal-center-vacant-land/journal-center-vacant-land-01.jpg",
    alt: "Aerial overview of vacant land near Journal Center in Albuquerque, New Mexico",
    gallery: [
...
export default function Home() {
  return <main>
    ...
    <section className="content-section industries-section"><header className="section-heading" data-reveal><p>Who we support</p><h2>Industries We Serve</h2></header><p className="industries-intro" data-reveal>Practical aerial documentation for teams that need a clearer view of a property, project, or site.</p><div className="industry-grid" data-reveal><span>Construction</span><span>Property Management</span><span>Commercial Real Estate</span><span>Development</span><span>Engineering Teams</span><span>Building Owners</span></div></section>
    <section id="portfolio" className="portfolio content-section"><header className="section-heading"><p>Selected flights</p><h2>Recent Work</h2></header><PortfolioCarousel items={work} /><a className="portfolio-button" href="#contact">Ask About Your Project</a></section>
