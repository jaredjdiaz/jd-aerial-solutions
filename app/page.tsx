...
const work = [
  { title: "Mountain Cabin", detail: "Personal aerial study · Bayfield, Colorado", category: "Property marketing", image: "/images/colorado-springs-cabin.png", alt: "Aerial view of a mountain cabin near Bayfield, Colorado" },
  {
    ...
    image: "/images/roof-documentation/metal-roof-overview-edited.jpg",
    alt: "Aerial overview of a residential metal roof in Albuquerque, New Mexico",
    gallery: [
      { image: "/images/roof-documentation/metal-roof-overview-edited.jpg", alt: "Aerial overview of a residential metal roof in Albuquerque, New Mexico" },
      { image: "/images/roof-documentation/metal-roof-roof-plane-edited.jpg", alt: "Aerial view showing the roof planes and roof-mounted features" },
      { image: "/images/roof-documentation/metal-roof-roof-detail-edited.jpg", alt: "Straight-down aerial view of roof vents and a skylight" },
      { image: "/images/roof-documentation/metal-roof-overhead-edited.jpg", alt: "Overhead aerial view showing skylights and vents on a metal roof" },
      { image: "/images/roof-documentation/metal-roof-top-down-edited.jpg", alt: "Top-down aerial view of multiple roof sections and skylights" },
    ],
  },
];
