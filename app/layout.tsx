...
export const metadata: Metadata = { title: "JD Aerial Solutions | Aerial Photography & Documentation", description: "Professional aerial photography, project documentation, and commercial imagery." };
