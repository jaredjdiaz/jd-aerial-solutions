...
export default function PrivacyPage() {
  return <main className="privacy-page">
    <Navbar />
    <section className="privacy-hero"><p>JD Aerial Solutions</p><h1>Privacy Policy</h1><span>Last updated: July 30, 2026</span></section>
    <article className="privacy-content">
      ...
      <section><h2>How information is handled</h2><p>We use trusted service providers to operate our website, deliver quote requests, manage business communications, and understand how visitors use our site. They may process information only as needed to provide those services to us. We do not sell your personal information or use it for advertising-based tracking.</p></section>
      <section><h2>Cookies and analytics</h2><p>With your permission, we use Google Analytics to understand site traffic and how visitors use our pages. Google Analytics may use cookies or similar technologies to collect general usage information, such as pages viewed, device or browser type, and the source that referred you to our site. We use this information to improve the website and do not use it for advertising-based tracking. You can accept or decline analytics when you visit the site.</p></section>
